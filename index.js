...
console.log('task 1b: ', createMenuItem('smash burgers', 7, 'Lunch'));
console.log('task 1b: ', createMenuItem('egg w/ biscuit', 4, 'Breakfast'));
console.log('task 1b: ', createMenuItem('crab cakes', 12, 'Dinner' ));
